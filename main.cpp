...
//        glfwWindowHint(GLFW_RESIZABLE, GLFW_FALSE);
    ...
    void createDescriptorSetLayout() {
        ...
        // Specify shader stages the descriptor is going to be referenced.
        ...
        if (vkCreateDescriptorSetLayout(device, &layoutInfo, nullptr, &descriptorSetLayout) !=
                VK_SUCCESS) {
            throw std::runtime_error("failed to create Decriptor set layout!");
        }
    ...
    void createGraphicsPipeline() {
        ...
        // Tells vulkan in which pipeline stage shader should be used.
        vertShaderStageInfo.module = vertShaderModule;
        vertShaderStageInfo.pName = "main";

        // Similar thing happens to fragment shader.
        ...
        // Combine vertex shader info and fragment shader info.
        VkPipelineShaderStageCreateInfo shaderStages[] = {vertShaderStageInfo, fragShaderStageInfo};

        // Define the format of the vertex data that will be passed to the vertex shader.
...
//        vertexInputInfo.vertexAttributeDescriptionCount = 0;
        ...
        //<---------Filling in viewport state info--------->//
...
//        dynamicState.pDynamicStates = dynamicStates;
        ...
        // Destroy Shader module since they will be no longer used.
    ...
    void createRenderPass() {
        // Use a single color buffer attachment represented by one of the images from the swap chain.
        VkAttachmentDescription colorAttachment = {};
        colorAttachment.format = swapChainImageFormat;
        colorAttachment.samples = VK_SAMPLE_COUNT_1_BIT;

        // Swap chain image attachment loading & storing option.
...
//            std::cout<<"Device incomplete!"<<std::endl;
//        else if (!extensionsSupported)
//            std::cout<<"ExtensionsNotSupport!"<<std::endl;
//        else if (!swapChainAdequate)
//            std::cout<<"SwapChainNotAvailable!"<<std::endl;
     ...
     *  Check if the physical device support queue type: VK_queue_graphics_bit
     * @param device
     * @return
     */
    ...
    void setupDebugCallback() {
        ...
        // flags field allows you to filter which types of msg you would like to receive.
...
//        std::cout<<"Time = "<<time<<std::endl;
        ...
        // Y coordinate of the clip coordinates is inverted in glm, thus we need to flip the sign.
        ubo.proj[1][1] *= -1;
    ...
    void createInstance() {
        // Check if we are able to enable all requested layers.
...
//        createInfo.ppEnabledExtensionNames = glfwExtensions;
     ...
     * @return the required list of extensions based on validation layers are
     *      enabled or not.
     */
    ...
    /**
     * @brief debugCallback
     * @param flags: Type of msg
     * @param objType: Type of obj
     * @param obj
     * @param location
     * @param code
     * @param layerPrefix
